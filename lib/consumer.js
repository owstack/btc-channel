...
var $ = require('btc-lib').util.preconditions;

var Script = require('btc-lib').Script;
var Networks = require('btc-lib').Networks;
var PrivateKey = require('btc-lib').PrivateKey;
var PublicKey = require('btc-lib').PublicKey;
var Address = require('btc-lib').Address;
var _ = require('btc-lib').deps._;
 ...
 *
 * @param {btcLib.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {btcLib.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {btcLib.Transaction} the updated transaction
 */
