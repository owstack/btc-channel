 ...
 *
 * @param {btc.PrivateKey=} opts.commitmentKey - key to use when negotiating the channel
 *
 ...
 *
 * @param {btc.PrivateKey=} opts.fundingKey - key to use for funding the channel
 ...
 * @return {btc.Transaction} the updated transaction
 */
